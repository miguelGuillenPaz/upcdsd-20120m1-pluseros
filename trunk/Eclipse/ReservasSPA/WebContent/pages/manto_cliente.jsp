		...
		<tr>
			<td>
				<% if(request.getParameter("sus").equals("ok")){ %>
					<div id="breadcrumb">
						<ul class="crumbs">
							<li class="first"><s:a href="#" style="z-index:9;"><span></span>Suscripci&oacute;n de Cliente</s:a></li>
						</ul>
					</div>
				<%}else{ %>
					<div id="breadcrumb">
						<ul class="crumbs">
							<li class="first"><s:a action="mantenerCliente.action" style="z-index:9;"><span></span>Mantenimiento de Clientes</s:a></li>
						</ul>
					</div>
				<%} %>
			</td>
							...
							<td colspan="3" height="20" align="center" >
								...
								<table width="100%" class="tbl_Manto_Registro" style="background-color: #B7B7B7;" cellpadding="1" cellspacing="1" border="0">
									<tr>
										...
										<td width="30%" >&nbsp; <s:textfield disabled="true" cssStyle="width:120px" id="objClienteDTO.codigo" name="objClienteDTO.codigo" /> </td>
										<td width="15%" class="label" > Nombre &nbsp; </td>
										<td width="30%" >&nbsp; <s:textfield required="true" cssStyle="width:230px"  maxlength="50"  id="objClienteDTO.nombres" name="objClienteDTO.nombres" /> </td>
									</tr>
									<tr>
										<td height="20" width="15%" class="label" > Apellido Pat. &nbsp; </td>
										<td width="30%" >&nbsp; <s:textfield cssStyle="width:230px" maxlength="50" id="objClienteDTO.apellidoPaterno" name="objClienteDTO.apellidoPaterno" /> </td>
										<td width="15%" class="label" > Apellido Mat. &nbsp; </td>
										<td width="30%" >&nbsp; <s:textfield  cssStyle="width:230px" maxlength="50" id="objClienteDTO.apellidoMaterno" name="objClienteDTO.apellidoMaterno" /> </td>
									</tr>
									<tr>
										<td height="20" width="15%" class="label" > Direcci&oacute;n&nbsp; </td>
										<td width="30%" colspan="3">&nbsp; <s:textfield cssStyle="width:570px"  maxlength="100"  id="objClienteDTO.direccion" name="objClienteDTO.direccion" /> </td>
									</tr>
									<tr>
										<td height="20" width="15%" class="label" > Documento &nbsp; </td>
										<td width="30%" >&nbsp; 
											<s:select id="objClienteDTO.tipoDocumentoIdentidad" name="objClienteDTO.tipoDocumentoIdentidad" cssStyle="width:230px" list="#{'16':'DNI','17':'CARNET DE EXTRANJERIA','18':'PASAPORTE'}" >
											</s:select>
										 </td>
										<td width="15%" class="label" > N&ordm; Documento </td>
										<td width="30%" >&nbsp; <s:textfield cssStyle="width:120px" maxlength="30" id="objClienteDTO.nroDocumentoIdentidad" name="objClienteDTO.nroDocumentoIdentidad" /> </td>
									</tr>
									<tr>
										<td height="20" width="15%" class="label" > Tel&eacute;fono &nbsp; </td>
										<td width="30%" >&nbsp; <s:textfield onkeypress="return validarSoloNumeros(event);" maxlength="15" cssStyle="width:120px" id="objClienteDTO.telefono" name="objClienteDTO.telefono" /> </td>
										<td width="15%" class="label" > <s:text name="M_Usuarios.mail"/> &nbsp; </td>
										<td width="30%" >&nbsp; <s:textfield  cssStyle="width:230px" maxlength="50" id="objClienteDTO.email" name="objClienteDTO.email" /> </td>
									</tr>
									<tr>
										<td height="20" width="15%" class="label" > Usuario &nbsp; </td>
										<td width="30%" >&nbsp; <s:textfield cssStyle="width:120px" maxlength="15" id="objClienteDTO.usuario" name="objClienteDTO.usuario" /> </td>
										<td width="15%" class="label" > Clave &nbsp; </td>
										<td width="30%" >&nbsp; <s:password  cssStyle="width:120px" maxlength="25" id="objClienteDTO.clave" name="objClienteDTO.clave" /> </td>
									</tr>
									<tr>
